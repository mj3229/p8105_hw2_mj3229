...
```
    ...
    ## Warning in left_join(zori_df, neighborhood_df, by = c("zip_code")): Detected an unexpected many-to-many relationship between `x` and `y`.
...
The dataset contains a total of 17516 observations across 15 variables.
There are 149 unique ZIP codes represented and 43 unique neighborhoods.
